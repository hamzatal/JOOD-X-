...
export default function JoodRegister() {
        ...
        <div className={`min-h-screen ${darkMode ? "dark" : ""}`}>
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50 dark:from-[#0F0F0F] dark:via-[#1a1a1a] dark:to-[#0a2f1a] transition-colors duration-500">
                ...
                <div className="relative min-h-screen flex">
                    ...
                    >
                        <div className="relative w-full h-full flex flex-col justify-center px-12 xl:px-15">
                            {/* Welcome message */}
                            <div className="mb-10">
                                ...
                                <p className="text-lg text-gray-600 dark:text-gray-400">
                                    Start your journey with AI-powered cooking
                                    assistance and personalized meal planning
                                </p>
                            </div>
